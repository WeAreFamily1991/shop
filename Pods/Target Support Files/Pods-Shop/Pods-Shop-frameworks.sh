...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CDDPagerController/CDDPagerController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FMDB/FMDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FWCycleScrollView/FWCycleScrollView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SKFPicPreview/SKFPicPreview.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVProgressHUD/SVProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TFDropDownMenu/TFDropDownMenu.framework"
