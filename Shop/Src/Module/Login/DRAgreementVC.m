...
@interface DRAgreementVC ()<WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@/appview/agreement",HTML_ROOT];
