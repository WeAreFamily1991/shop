...
#define collectionCellH    ((WScale(300) - 30)/2 + 97)
...
- (void)createView
{
    self.leftTabView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0,WScale(75), self.height-_maxOffset_Y) style:UITableViewStyleGrouped];
    self.leftTabView.dataSource = self;
    self.leftTabView.delegate = self;
    self.leftTabView.backgroundColor = RGBHex(0xF4F4F4);
    self.leftTabView.tableFooterView = [UIView new];
    self.leftTabView.separatorColor = RGBHex(0XE2E2E2);
    self.leftTabView.showsVerticalScrollIndicator = NO;
    [self addSubview:self.leftTabView];
    
    UILabel *line = [UITool lineLabWithFrame:CGRectMake(WScale(75)-0.5, 0, 0.5, self.height)];
...
{
    self.rightTabView = [[UITableView alloc]initWithFrame:CGRectMake(WScale(75), 0,WScale(300), self.height) style:UITableViewStylePlain];
    ...
    self.rightTabView.separatorColor = RGBHex(0XE2E2E2);
...
- (void)createCollectionView
{
    ...
    _layout.headerReferenceSize = CGSizeMake(WScale(300), 34);
    _layout.scrollDirection = UICollectionViewScrollDirectionVertical;
    //设置列表视图
    _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(WScale(75), 0,WScale(300), self.height) collectionViewLayout:_layout];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    if (tableView == _leftTabView) {
        bgView.backgroundColor = RGBHex(0xF4F4F4);
    }
    return bgView;
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if (tableView == _rightTabView) {
        ...
        UILabel *titleLab = [UITool createLabelWithFrame:CGRectMake(line.maxX+7,0, 200, 34) backgroundColor:[UIColor clearColor] textColor:[UIColor grayColor] textSize:12 alignment:NSTextAlignmentLeft lines:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView == _leftTabView) {
        ...
        if (!cell) {
            ...
            UILabel *titleLab = [UITool createLabelWithFrame:CGRectMake(0,0, WScale(75), 50) backgroundColor:[UIColor clearColor] textColor:[UIColor darkGrayColor] textSize:13 alignment:NSTextAlignmentCenter lines:1];
            titleLab.tag = 10;
        ...
        cell.backgroundColor = RGBHex(0xF4F4F4);
        return cell;
