...
- (void)evluateItemClick:(UIButton *)btn
{
    ...
    lastBT.backgroundColor = RGBHex(0XD9D9D9);
    btn.backgroundColor = RGBHex(0XF85F4F);
...
- (void)createView
{
    ...
    _noDateLab = [UITool createLabelWithTextColor:[UIColor grayColor] textSize:12 alignment:NSTextAlignmentCenter];
