...
//    CGSize size = [AppMethods sizeAttributedWithFont: DR_FONT(14) Str:str withMaxWidth:takeawayRight_W-20];
//    CGFloat height = 20;
//    if (size.height > 20) {
//        height = 40;
//    }
    ...
    _productNameLabel.attributedText = @"hahahahahha";
    _productNameLabel.textColor = RGBA(51, 51, 51, 1);
    _productNameLabel.font = DR_FONT(14);
    ...
    _sellOutLab.textColor = [UIColor grayColor];
    ...
    _warningIcon.image = IMAGENAMED(@"icon_info_gray");
