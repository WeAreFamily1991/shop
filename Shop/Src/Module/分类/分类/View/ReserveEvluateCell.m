...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //用户名称
        _userNameLab = [UITool createLabelWithFrame:CGRectMake(44, 18, 200, 18) backgroundColor:[UIColor clearColor] textColor:[UIColor darkGrayColor] textSize:14 alignment:NSTextAlignmentLeft lines:1];
