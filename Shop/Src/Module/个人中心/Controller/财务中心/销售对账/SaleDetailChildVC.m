...
{
    ChildCustomHeadView *headView = [[[NSBundle mainBundle] loadNibNamed:@"ChildCustomHeadView" owner:self options:nil] lastObject]; // lastObject 可改为 firstObject，该数组只有一个元素，写哪个都行，看个人习惯。
    self.tableView.tableHeaderView =headView;
}
-(void)addCustomHeadView
{
    CustomHeadView *headView = [[[NSBundle mainBundle] loadNibNamed:@"CustomHeadView" owner:self options:nil] lastObject]; // lastObject 可改为 firstObject，该数组只有一个元素，写哪个都行，看个人习惯。
    self.tableView.tableHeaderView =headView;
