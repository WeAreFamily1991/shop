...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    ...
    if ( section == 1 || section==2||section==4||section==6) { //广告福利  倒计时  掌上专享
        return 1;
    }
...
//        cell.gridItem = _gridItem[indexPath.row];
    ...
    else if (indexPath.section == 6) {//掌上专享
    ...
    if (kind == UICollectionElementKindSectionFooter)
    {
        ...
        if (indexPath.section == 0) {
            ...
            DCCountDownHeadView *footerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:DCCountDownHeadViewID forIndexPath:indexPath];
                    ...
                    footerView.timeLabel.text =@"精选卖家";
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 6) {//猜你喜欢
        return CGSizeMake(ScreenW,  HScale(190));;
    }
    if (indexPath.section == 7) {//猜你喜欢
        return CGSizeMake((ScreenW-6)/3, (ScreenW-6)/2.5);
    }
    return CGSizeZero;
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section {
    ...
    if (section == 2 ||section == 3||section == 5||section == 6) {
        return CGSizeMake(ScreenW, 40);  //Top头条的宽高
    }
    if (section==4) {
       return CGSizeMake(ScreenW, 80);  //scroll
    }
//    if (section == 3) {
