...
@interface CategoryDetailVC ()<GHCountFieldDelegate>
{
    int pageCount;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        {
            static NSString *SimpleTableIdentifier = @"cellSelect";
            ...
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
                GHCountField *countField = [[GHCountField alloc]initWithFrame:CGRectMake(WScale(80), 5, WScale(120), HScale(25))];
                countField.count = 4;
                ...
                UIView *selectView =[[UIView alloc]initWithFrame:CGRectMake(countField.right+10, 5, WScale(100), HScale(25))];
