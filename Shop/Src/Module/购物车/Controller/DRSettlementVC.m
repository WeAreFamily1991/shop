...
//
    ...
    if ([message.name isEqualToString:@"openAddress"]) {
        ...
        addressVC.changeURLBLOCK = ^(NSString *addressid) {
            //@"bea41641-f5e6-11e8-b89a-00163e104ad2"
            //@"bea41641-f5e6-11e8-b89a-00163e104ad2"
            //@"bea41641-f5e6-11e8-b89a-00163e104ad2" 
            NSString *allStr =[NSString stringWithFormat:@"%@&addressid=%@",self.urlStr,addressid];
