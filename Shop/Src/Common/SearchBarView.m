...
//    img.image = [UIImage imageNamed:@"HomePageSH_searchBack_bg"];
    ...
    img.layer.cornerRadius =self.backgroundView.frame.size.height/2;
    ...
    [self.searchButton setContentHorizontalAlignment:UIControlContentHorizontalAlignmentCenter];
    ...
    [self.searchButton setTitle:@"请输入关键词" forState:UIControlStateNormal];
