...
-(void)CreatUI{
    ...
    qxbtn=[UIButton new];
    qxbtn.backgroundColor=WHITECOLOR;
    ...
    [qxbtn setTitleColor:BLACKCOLOR forState:UIControlStateNormal];
    qxbtn.titleLabel.font =DR_FONT(15);
...
- (void)updateViewsFrame{
    ...
    titLa.frame =CGRectMake(0, 0, alertView.dc_width, HScale(40));
...
-(void)okTap{
    if (_textView.text.length==0) {
        [MBProgressHUD showSuccess:@"请输入取消原因"];
        return ;
    }
