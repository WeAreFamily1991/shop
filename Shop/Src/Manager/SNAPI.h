...
/**
 ...
 @param hanlder 错误处理
 */
+ (void)setTokenErrorHandler:(void (^)(NSError *error))hanlder;
 ...
 *  @param areaCode 地区编码
 */
+ (void)userLoginWithAccount:(NSString *)account password:(NSString *)password success:(void (^)())success failure:(void (^)(NSError *error))failure;
 ...
 *  推送消息列表
 */
+ (void)messagePushListWithPage:(NSInteger)page success:(void (^)(NSArray<SNMessage *> *messageArray))success failure:(void (^)(NSError *error))failure;
...
/**
 ...
 @param codeString 图形码
 @param success 返回MAC地址
 @param failure 返回错误
 */
+ (void)deviceInfoWithBarcode:(NSString *)codeString success:(void (^)(NSString *mac, NSString *type))success failure:(void (^)(NSError *error))failure;

/**
 *  获取用户分享出去的所有设备列表
 */
+ (void)deviceShareAllListSuccess:(void (^)(NSArray *shareList))success failure:(void (^)(NSError *error))failure;
...
typedef NS_ENUM(NSInteger, SNThirdpartyType) {
    ...
    SNThirdpartyTypeWechatOfficialAccounts      = 4
};
 ...
 *  绑定的第三方平台列表
 */
+ (void)thirdpartyGetBindListSuccess:(void(^)(NSArray *bindList))success failure:(void (^)(NSError *error))failure;
 ...
 *  @param type         第三方用户类型
 */
+ (void)thirdpartyDeleteWithThirdpartyType:(SNThirdpartyType)type success:(void (^)())success failure:(void (^)(NSError *error))failure;
...
/**
 ...
 @param dataDict 上传数据，格式为NSDictionary
 */
+ (void)bluetoothUploadDataWithDeviceID:(NSString *)deviceID sensorID:(NSString *)sensorID sensorType:(NSString *)sensorType dataDictionary:(NSDictionary *)dataDict success:(void (^)())success failure:(void (^)(NSError *error))failure;
...
/**
 ...
 @param type 二维码操作类型,01：生成分享设备的二维码
 @param deviceID 设备ID
 @param success 返回二维码字符串
 @param failure 返回错误
 */
+ (void)barcodeGenerateWithActionType:(NSInteger)type deviceID:(NSString *)deviceID success:(void (^)(NSString *barcode))success failure:(void (^)(NSError *error))failure;

/**
 扫描二维码

 @param barcode 二维码字符串
 */
+ (void)barcodeParseWithBarcode:(NSString *)barcode success:(void (^)())success failure:(void (^)(NSError *error))failure;
...
/**
 ...
 @param barcode 二维码字符串
 */
+ (void)barcodeAuthWithBarcode:(NSString *)barcode success:(void (^)())success failure:(void (^)(NSError *error))failure;
...
// @param success 返回子设备列表
// @param failure 返回错误信息
// */
//+ (void)zigbeeDeviceListWithDeviceID:(NSString *)deviceID success:(void (^)(NSArray *deviceArrary))success failure:(void (^)(NSError *error))failure;
//
///**
// 修改Zigbee子设备名称
//
// @param deviceID 网关设备id
// @param ieee Zigbee子设备唯一编号
// @param endPoint 子设备应用层入口地址
// @param title 子设备名称
// */
//+ (void)zigbeeDeviceEditWithDeviceID:(NSString *)deviceID ieee:(NSString *)ieee endPoint:(NSString *)endPoint title:(NSString *)title success:(void (^)())success failure:(void (^)(NSError *error))failure;
//
///**
// 删除Zigbee子设备
//
...
// @param ieee Zigbee子设备唯一编号
// @param endPoint 子设备应用层入口地址
// @param shortAddr 子设备短地址
// */
//+ (void)zigbeeDeviceDeleteWithDeviceID:(NSString *)deviceID ieee:(NSString *)ieee endPoint:(NSString *)endPoint shortAddr:(NSString *)shortAddr success:(void (^)())success failure:(void (^)(NSError *error))failure;
//
///**
// 获防安防设备已学习防区列表
//
// @param deviceID 网关设备id
// @param alarmType 安防传感器类型
// @param success 区域列表回调
// @param failure 失败回调
// */
//+ (void)alarmAreaListWithDeviceID:(NSString *)deviceID alarmType:(NSString *)alarmType success:(void (^)(NSArray *areaArrary))success failure:(void (^)(NSError *error))failure;
//
///**
// 修改安防设备防区名称
//
...
// @param title 防区标题
// */
//+ (void)alarmAreaEditWithDeviceID:(NSString *)deviceID areaID:(NSString *)areaID title:(NSString *)title success:(void (^)())success failure:(void (^)(NSError *error))failure;
